...
plt.text(2.3, 0.3, r"$SD = %.3f$ N"%(F_std),  fontsize = 8)
plt.text(2.3, 0.6, r"$Avg = %.3f$ N"%(F_mean),  fontsize = 8)
plt.text(3.8, 0.3, r"$Fmax = %.3f$ N"%(F_max),  fontsize = 8)
plt.text(3.8, 0.6, r"$Fmin = %.3f$ N"%(F_min),  fontsize = 8)
plt.xlabel('Elongation (mm)')
plt.ylabel('Force (N)')
...
plt.text(0, 1420, r"$Rmax = %.3f$ Ω"%(R_max),  fontsize = 8)
