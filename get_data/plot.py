...
U_mean = np.mean(U)										# Avg = 3.025 V
print("Average Voltage = ", U_mean, "V")
U_std = np.std(U)										# SD  = O.O96 V
print("Standart Deviation = ", U_std, "V")
...
plt.text(4.5, 3.26, r"$SD = %.3f$ V"%(U_std),  fontsize = 8)
plt.text(4.5, 3.22, r"$Avg = %.3f$ V"%(U_mean),  fontsize = 8)
