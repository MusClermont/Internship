...
for j in range(49):
	...
	SM_GP_value = SM_initial_value + j*15							# 1 deg rotation = 11.37
	...
	if (len(list_data) == 9) :								# Ignore empty lines or lines with missing caracters
		voltage = float (list_data[7].decode())					# Convert string to float
		#print ('U : ', voltage,'V')
		force = float (list_data[2].decode())
		#print ("F : ", force, ' N')
...
for i in range (len(list_t)):
	...
	lines.append(line)
fichier = open('data_arduino_test3.txt','w').writelines(lines)	
